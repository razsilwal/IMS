    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField()),
                ('department_id', models.ManyToManyField(to='api.department')),
                ('type_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.producttype')),
            ],
        ),
        migrations.CreateModel(
            name='Sell',
